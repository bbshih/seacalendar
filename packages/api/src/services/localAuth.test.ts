...
describe('Local Auth Service', () => {
  ...
  describe('register', () => {
    it('should successfully register a new user', async () => {
      ...
      vi.mocked(prisma.user.create).mockResolvedValue({
        ...expectedUser,
        preferences: { id: 'pref-123', userId: 'user-123', createdAt: new Date(), updatedAt: new Date() },
        authProviders: [
    ...
    it('should reject invalid username format', async () => {
      ...
      await expect(localAuthService.register(registerData)).rejects.toThrow('Invalid username format');
    });
    ...
    it('should reject weak password', async () => {
      ...
      await expect(localAuthService.register(registerData)).rejects.toThrow(ApiError);
      await expect(localAuthService.register(registerData)).rejects.toThrow('Password must be at least 8 characters');
    });
    ...
    it('should reject duplicate username', async () => {
      ...
      await expect(localAuthService.register(registerData)).rejects.toThrow(ApiError);
      await expect(localAuthService.register(registerData)).rejects.toThrow('Username already taken');
    });
    ...
    it('should reject duplicate email', async () => {
      ...
      await expect(localAuthService.register(registerData)).rejects.toThrow(ApiError);
      await expect(localAuthService.register(registerData)).rejects.toThrow('Email already registered');
    });
  ...
  describe('login', () => {
    ...
    it('should reject login with invalid username', async () => {
      ...
      await expect(localAuthService.login(loginData)).rejects.toThrow('Invalid username or password');
    });
    ...
    it('should reject login if Discord link deadline passed', async () => {
      ...
      await expect(localAuthService.login(loginData)).rejects.toThrow(ApiError);
      await expect(localAuthService.login(loginData)).rejects.toThrow('Account requires Discord linking');
    });
  ...
  describe('changePassword', () => {
    ...
    it('should reject if user not found', async () => {
      ...
      await expect(localAuthService.changePassword('user-123', 'Old123', 'New456')).rejects.toThrow(ApiError);
      await expect(localAuthService.changePassword('user-123', 'Old123', 'New456')).rejects.toThrow('User not found');
    });
    ...
    it('should reject if user has no password hash', async () => {
      ...
      await expect(localAuthService.changePassword('user-123', 'Old123', 'New456')).rejects.toThrow(ApiError);
      await expect(localAuthService.changePassword('user-123', 'Old123', 'New456')).rejects.toThrow('does not have password auth');
    });
    ...
    it('should reject if current password is incorrect', async () => {
      ...
      await expect(localAuthService.changePassword(userId, currentPassword, newPassword)).rejects.toThrow(ApiError);
      await expect(localAuthService.changePassword(userId, currentPassword, newPassword)).rejects.toThrow('Current password is incorrect');
    });
    ...
    it('should reject weak new password', async () => {
      ...
      await expect(localAuthService.changePassword(userId, currentPassword, newPassword)).rejects.toThrow(ApiError);
      await expect(localAuthService.changePassword(userId, currentPassword, newPassword)).rejects.toThrow('New password must be at least 8 characters');
    });
  });
