...
import { createMockPoll, createMockPollOption, createMockVote, createMockUser } from '../test/testData';
...
describe('Vote Service', () => {
  ...
  describe('submitVote', () => {
    ...
    it('should throw error if poll not found', async () => {
      ...
      await expect(voteService.submitVote(pollId, userId, voteData)).rejects.toThrow('Poll not found');
    });
