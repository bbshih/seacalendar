...
import { IconList, IconSparkles, IconLoader, IconChecklist, IconChartBar } from '@tabler/icons-react';
...
import DatePatternPresets from '@/components/features/DatePatternPresets';
          ...
          >
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <Button
                  variant="primary"
                  onClick={() => router.push(`/results/${createdPoll.id}`)}
                  className="flex-1"
                >
                  View Results
                </Button>
